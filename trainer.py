...
from experiment.experiments import BaseExperimentManager
    ...
    def run(self):
        ...
        for epoch in range(1, e.args.max_epochs + 1):
            for batch_idx, (x, y) in enumerate(train_loader):
                ...
                step = e.model.module.global_step
                ...
                if step % e.args.test_log_every == 0:
                    ...
                    steps_start = e.model.module.global_step
                ...
                if (step + 1) % e.args.train_log_every == 0:
                    ...
                    iterations = e.model.module.global_step - steps_start
                ...
                e.model.module.increment_global_step()
