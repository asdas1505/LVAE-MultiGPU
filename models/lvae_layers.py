...
class TopDownLayer(nn.Module):
    ...
    The architecture when doing inference is roughly as follows:
       ...
       possibly get skip connection from previous top-down layer[[/5trf
    ...
    def forward(self,
        ...
        """
        If iteratively optimizing params of posterior:
        Put -> iUpdate = True
            -> Store q_params as a parameter to be trained
        """
        ...
        return x, x_pre_residual, data, p_params
